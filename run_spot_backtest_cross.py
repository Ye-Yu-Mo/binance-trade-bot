"""
现货回测主脚本 - Cross Sectional 策略

用法：
    python run_spot_backtest_cross.py
"""
from datetime import datetime
from binance.client import Client
from binance_trade_bot.config import Config
from binance_trade_bot.spot_backtest import SpotBacktestEngine
from binance_trade_bot.strategies.cross_sectional_strategy import Strategy as CrossSectionalStrategy
...
def main():
    ...
    engine = SpotBacktestEngine(
        strategy_class=CrossSectionalStrategy,
        config=config,
